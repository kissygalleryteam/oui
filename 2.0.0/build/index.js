...
kg/oui/2.0.0/handler
kg/oui/2.0.0/schemas/options
kg/oui/2.0.0/schemas/accessors
kg/oui/2.0.0/schemas/binding
kg/oui/2.0.0/schemas/promise
kg/oui/2.0.0/schemas/time
kg/oui/2.0.0/schemas/data
kg/oui/2.0.0/Handler
kg/oui/2.0.0/schemas/template
kg/oui/2.0.0/schemas/events
kg/oui/2.0.0/schemas/register
kg/oui/2.0.0/schemas/factory
kg/oui/2.0.0/schemas/keyboard
kg/oui/2.0.0/index

*/
KISSY.add('kg/oui/2.0.0/handler',function(S, oop) {
...
KISSY.add('kg/oui/2.0.0/schemas/options',function(S, oop, Handler) {
...
KISSY.add('kg/oui/2.0.0/schemas/accessors',function(S, oop, Handler) {
...
KISSY.add('kg/oui/2.0.0/schemas/binding',function(S, oop, Handler) {
...
KISSY.add('kg/oui/2.0.0/schemas/promise',function(S, Promise) {
...
KISSY.add('kg/oui/2.0.0/schemas/time',function(S, oop) {
...
KISSY.add('kg/oui/2.0.0/schemas/data',function(S, oop, Handler, binding, promise, time, IO, Mustache) {
...
return {
    ...
    requires: ['kg/oop/0.1/index', '../handler', './binding', './promise', './time', 'ajax', 'brix/kg/mu/index']
});
KISSY.add('kg/oui/2.0.0/Handler',function(S, oop) {
...
KISSY.add('kg/oui/2.0.0/schemas/template',function(S, oop, promise, Handler, dom, Mustache) {
...
KISSY.add('kg/oui/2.0.0/schemas/events',function(S, oop, Handler, accessors, event) {
...
return {
	...
	requires: ['kg/oop/0.1/index', '../handler', './accessors', 'event']
});
KISSY.add('kg/oui/2.0.0/schemas/register',function(S, oop, Handler) {
...
KISSY.add('kg/oui/2.0.0/schemas/factory',function(S, oop, Handler, data, accessors, options) {
...
KISSY.add('kg/oui/2.0.0/schemas/keyboard',function(S, oop, promiseSchema) {
...
KISSY.add('kg/oui/2.0.0/index',function(S, event, Node, oop, options, accessors, dataSchema, template, events, promise, register, factory, time, keyboard, binding) {
